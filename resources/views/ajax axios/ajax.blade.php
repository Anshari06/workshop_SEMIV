...
@section('content')
    ...
    <div class="page-header">
        <h3 class="page-title">
            ...
            </span> Modul 5 - Wilayah Administrasi Indonesia (AJAX)
        </h3>
    ...
    <div class="region-wrapper">
        <div class="region-card">
            ...
            <div class="region-card-body">
                <form id="regionForm" novalidate>
                    <div class="select-grid">
                        <div class="form-group">
                            <label for="selectProvinsi">Provinsi (Level 1)</label>
                            <select id="selectProvinsi" name="provinsi" required>
                        ...
                        <div class="form-group">
                            <label for="selectKota">Kota (Level 2)</label>
                            <select id="selectKota" name="kota" required disabled>
                                <option value="0">Pilih Kota</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="selectKecamatan">Kecamatan (Level 3)</label>
                        ...
                        <div class="form-group">
                            <label for="selectKelurahan">Kelurahan (Level 4)</label>
                            <select id="selectKelurahan" name="kelurahan" required disabled>
                ...
                <div class="table-wrapper">
                    <table class="region-table table table-bordered table-hover">
                        ...
                        <tbody id="regionTableBody">
                            <tr>
                                <td colspan="5" class="empty-state">Belum ada data. Silakan pilih wilayah dan tambahkan ke tabel.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            selectProvinsi.addEventListener('change', function() {
                ...
                window.jQuery.ajax({
                    url: endpointRegencies,
                    method: 'GET',
                    dataType: 'json',
                    data: { province_id: provinceId }
                }).done(function(regencies) {
                    setOptions(selectKota, regencies, 'Pilih Kota');
                }).fail(function() {
            ...
            selectKota.addEventListener('change', function() {
                ...
                window.jQuery.ajax({
                    url: endpointDistricts,
                    method: 'GET',
                    dataType: 'json',
                    data: { regency_id: regencyId }
                }).done(function(districts) {
                    setOptions(selectKecamatan, districts, 'Pilih Kecamatan');
                }).fail(function() {
            ...
            selectKecamatan.addEventListener('change', function() {
                ...
                window.jQuery.ajax({
                    url: endpointVillages,
                    method: 'GET',
                    dataType: 'json',
                    data: { district_id: districtId }
                }).done(function(villages) {
                    setOptions(selectKelurahan, villages, 'Pilih Kelurahan');
                }).fail(function() {
            ...
            regionForm.addEventListener('submit', function(event) {
                ...
                if (selectProvinsi.value === '0' || selectKota.value === '0' || selectKecamatan.value === '0' || selectKelurahan.value === '0') {
                ...
                if (regionTableBody.childElementCount === 1 && regionTableBody.querySelector('.empty-state')) {
