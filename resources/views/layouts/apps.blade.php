...
<head>
    ...
    <link rel="stylesheet" href="//{{ $host }}/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css">
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="//{{ $host }}/assets/images/apple-logo.png">
</head>
...
<body>
    ...
    <script src="//{{ $host }}/assets/vendors/chart.js/chart.umd.js"></script>
    <script src="//{{ $host }}/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
    ...
    <script src="//{{ $host }}/assets/js/dashboard.js"></script>
