...
@section('content')
    <div class="page-header">
        <h3 class="page-title">
            ...
            </span> Tambah Customer 1 (Simpan BLOB)
        </h3>
    </div>
        ...
        <div class="col-md-10 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('customer-camera.store.blob') }}" id="customerBlobForm">
                        @csrf
    ...
    <script>
        ...
        const form = document.getElementById('customerBlobForm');
